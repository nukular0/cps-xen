...
extern const struct libxl_device_type libxl__vgpio_devtype;
extern const struct libxl_device_type libxl__vspi_devtype;
extern const struct libxl_device_type libxl__vcan_devtype;
